...
namespace Nethereum.Uniswap.Contracts.pumpfunBase.ContractDefinition
{


    public partial class pumpfunBaseDeployment : pumpfunBaseDeploymentBase
    {
        public pumpfunBaseDeployment() : base(BYTECODE) { }
        public pumpfunBaseDeployment(string byteCode) : base(byteCode) { }
    }

    public class pumpfunBaseDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public pumpfunBaseDeploymentBase() : base(BYTECODE) { }
        public pumpfunBaseDeploymentBase(string byteCode) : base(byteCode) { }
