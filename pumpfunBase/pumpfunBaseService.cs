...
using Nethereum.Uniswap.Contracts.pumpfunBase.ContractDefinition;

namespace Nethereum.Uniswap.Contracts.pumpfunBase
{
    public partial class pumpfunBaseService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, pumpfunBaseDeployment pumpfunBaseDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<pumpfunBaseDeployment>().SendRequestAndWaitForReceiptAsync(pumpfunBaseDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, pumpfunBaseDeployment pumpfunBaseDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<pumpfunBaseDeployment>().SendRequestAsync(pumpfunBaseDeployment);
        }

        public static async Task<pumpfunBaseService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, pumpfunBaseDeployment pumpfunBaseDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, pumpfunBaseDeployment, cancellationTokenSource);
            return new pumpfunBaseService(web3, receipt.ContractAddress);
        }
        ...
        public pumpfunBaseService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
